...
public class ProductionRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText edtTxtQuantity = (EditText) findViewById(R.id.edtTxtQuantity);
        edtTxtQuantity.setBackground(getResources().getDrawable((R.color.colorLightGray)));

        final EditText edtTxtMixingRound = (EditText) findViewById(R.id.edtTxtMixingRound);
        edtTxtMixingRound.setBackground(getResources().getDrawable(R.color.colorLightBlue));
